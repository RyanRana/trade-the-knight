...
# Thresholds
PRED_EDGE_MIN   = 0.10       # trade only when |market - estimate| > 10¢
VRP_EDGE_MIN    = 0.10       # sell option when (IV-RV)/RV > 10%
TRI_EDGE_MIN    = 0.001      # >10 bps after spread costs
BAYES_POSTERIOR_EDGE = 0.15

VOL_WINDOW      = 60
MAX_HOLD_SEC    = 1800.0     # auto-flatten event positions after 30 min
