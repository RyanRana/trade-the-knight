...
QUOTE_INSIDE         = 0.02
BASE_SIZE_PCT        = 0.008
MAX_INVENTORY_PCT    = 0.03
SKEW_STRENGTH        = 0.7
MIN_REFRESH_SEC      = 0.20
MAX_SYMBOLS          = 12

# S/R + MR overlay parameters ---------------------------------------------
SR_WINDOW            = 50      # ticks for support/resistance rolling window
MR_BAND_PCT          = 0.01    # mid must cross S/R by 1% to trigger MR
MR_SIZE_PCT          = 0.04    # extra size when MR overlay fires
