...
bot: tick_sniper
trials: 60
baseline_score: -20247.03
best_score: -12054.83
improvement: +8192.20
best_overrides: {'SIGMA_EWMA_ALPHA': 0.05, 'MIN_PRINTS_FOR_SIG': 40, 'MAX_HOLD_PRINTS': 5, 'MAX_HOLD_SEC': 10.0, 'HARD_STOP_PCT': 0.025, 'MIN_RE_ENTRY_SEC': 0.5}
...
# --- Signal ---------------------------------------------------------------
SIGMA_EWMA_ALPHA   = 0.05       # ~10 effective samples
MIN_PRINTS_FOR_SIG = 40
MAX_HOLD_PRINTS    = 5          # hard tick-count exit
MAX_HOLD_SEC       = 10.0       # hard time exit (in case prints dry up)
MIN_RE_ENTRY_SEC   = 0.5        # cooldown per symbol after any entry/exit

# --- Risk -----------------------------------------------------------------
HARD_STOP_PCT       = 0.025      # -1.5% unrealized → cut
