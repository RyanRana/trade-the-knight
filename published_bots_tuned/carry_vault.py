...
bot: carry_vault
trials: 60
baseline_score: -4128.44
best_score: -3987.37
improvement: +141.07
best_overrides: {'FX_CARRY_THRESHOLD': 0.01, 'FX_POS_PCT': 0.08, 'BOND_BID_EDGE': 0.001, 'BOND_POS_PCT': 0.05, 'SANE_MAX_DEV': 0.05}
...
FX_POS_PCT          = 0.08     # per-pair carry position
BOND_BID_EDGE       = 0.001    # bid yield = fair_yield + 0.2% (aggressive)
BOND_POS_PCT        = 0.05     # max per-bond exposure
