...
bot: qfc_sniper
trials: 60
baseline_score: -10770.00
best_score: 1167.30
improvement: +11937.30
best_overrides: {'TRIGGER_Z': 1.5, 'SIZE_PCT': 0.01, 'HARD_STOP_PCT': 0.12, 'MAX_HOLD_OBS': 5, 'MAX_HOLD_SEC': 180.0, 'SIGMA_EWMA_ALPHA': 0.1}
...
# Signal
TRIGGER_Z           = 1.5         # 86% WR at this level in backtest
SIGMA_EWMA_ALPHA    = 0.1        # ~7 effective samples (fast adapt)
MIN_OBS_FOR_SIG     = 8           # warmup

# Execution
SIZE_PCT            = 0.01        # 3% of capital per entry
HARD_STOP_PCT       = 0.12        # -8% (QFC p05 snap return = -9.2%)
MAX_HOLD_OBS        = 5           # exit after this many new observations
MAX_HOLD_SEC        = 180.0
